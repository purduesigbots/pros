...
//More "Exposed" Text Printing Functions (Uncomment if Needed)
	/**
	 * Print a formatted string to the screen on the specified line
	 *
	 * \param line The line number on which to print
	...
	/**
	 * Print a large, formatted string to the screen at the specified
	 * 		  coordinates
	 *
	 * \param x, y The (x, y) coordinates of the top left corner of the string
	 * \param fmt  Format string
	...
	/**
	 * Print a small, formatted string to the screen at the specified
	 * 		  coordinates
	 *
	 * \param x, y The (x, y) coordinates of the top left corner of the string
	 * \param fmt  Format string
	...
	/**
	 * Print a large, centered, formatted string to the screen on the specified
	 * 		  line
	 *
	 * \param line The line number on which to print
	 * \param fmt  Format string
