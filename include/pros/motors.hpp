...
class Motor_Group {
	...
	std::vector<double> get_target_position_vector(void) const;
	...
	std::vector<std::int32_t> get_target_velocity_vector(void) const;
	...
	std::vector<double> get_actual_velocity_vector(void) const;
	...
	std::vector<std::int32_t> get_current_draw_vector(void) const;
	...
	std::vector<std::int32_t> get_direction_vector(void) const;
	...
	std::vector<double> get_efficiency_vector(void) const;
	...
	std::vector<std::uint32_t> get_faults_vector(void) const;
	/**
	...
	std::vector<std::uint32_t> get_flags_vector(void) const;
	...
	std::vector<double> get_position_vector(void) const;
	...
	std::vector<double> get_power_vector(void) const;
	/**
	...
	std::vector<std::int32_t> get_raw_position_vector(std::uint32_t* const timestamp) const;
	...
	std::vector<double> get_temperature_vector(void) const;
	/**
	...
	std::vector<double> get_torque_vector(void) const;
	/**
	...
	std::vector<std::int32_t> get_voltage_vector(void) const;
	...
	std::vector<std::int32_t> is_over_current_vector(void) const;
	...
	std::vector<std::int32_t> is_over_temp_vector(void) const;
	...
	std::vector<Motor_Brake> get_brake_mode_vector(void) const;
	...
	std::vector<std::int32_t> get_current_limit_vector(void) const;
	...
	std::vector<Motor_Units> get_encoder_units_vector(void) const;
	...
	std::vector<Motor_Gears> get_gearing_vector(void) const;
	...
	std::vector<std::int32_t> get_voltage_limit_vector(void) const;
	...
	std::vector<std::int32_t> is_reversed_vector(void) const;
