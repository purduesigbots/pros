...
class BaseMotor {
	 ...
	 * \endcode
	 */
	std::int32_t get_target_velocity(const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	double get_actual_velocity(const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	std::int32_t get_current_draw(const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	std::int32_t get_direction(const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	double get_efficiency(const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	std::uint32_t get_faults(const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	std::uint32_t get_flags(const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	double get_position(const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	double get_power(const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	std::int32_t get_raw_position(std::uint32_t* const timestamp, const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	double get_temperature(const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	double get_torque(const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	std::int32_t get_voltage(const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	std::int32_t is_over_current(const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	std::int32_t is_over_temp(const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	Motor_Brake get_brake_mode(const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	std::int32_t get_current_limit(const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	Motor_Units get_encoder_units(const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	Motor_Gears get_gearing(const std::uint8_t) const;
	 ...
	 */
	std::vector<std::uint8_t> get_port_all(void) const;
	 ...
	 * \endcode
	 */
	std::int32_t get_voltage_limit(const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	std::int32_t is_reversed(const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	std::int32_t set_brake_mode(const Motor_Brake mode, const std::uint8_t) const;
	std::int32_t set_brake_mode(const pros::motor_brake_mode_e_t mode, const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	std::int32_t set_current_limit(const std::int32_t limit, const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	std::int32_t set_encoder_units(const Motor_Units units, const std::uint8_t) const;
	std::int32_t set_encoder_units(const pros::motor_encoder_units_e_t units, const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	std::int32_t set_gearing(const Motor_Gears gearset, const std::uint8_t) const;
	std::int32_t set_gearing(const pros::motor_gearset_e_t gearset, const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	std::int32_t set_reversed(const bool reverse, const std::uint8_t);
	 ...
	 * \endcode
	 */
	std::int32_t set_voltage_limit(const std::int32_t limit, const std::uint8_t) const;
	 ...
	 *
	 */
	std::int32_t set_zero_position(const double position, const std::uint8_t) const;
	 ...
	 * \endcode
	 */
	std::int32_t tare_position(const std::uint8_t) const;
...
class MotorGroup : public virtual BaseMotor {
	...
	explicit MotorGroup(const std::vector<std::int8_t>& ports, const pros::v5::Motor_Gears gearset, const bool reverse,
	                    const pros::v5::Motor_Units encoder_units);
