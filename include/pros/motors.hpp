...
public:
  ...
  explicit Motor(
      ...
      const pros::c::motor_gearset_e_t gearset = pros::c::E_MOTOR_GEARSET_36,
   ...
   *         setting errno.
   */
  virtual std::int32_t move_velocity(const std::int16_t velocity) const;
   ...
   *         setting errno.
   */
  virtual std::int32_t move_voltage(const std::int16_t voltage) const;
   ...
   * be returned.
   *        If NULL, the timestamp at which the encoder count was read will not
   * be supplied
   *
   ...
   *         setting errno.
   */
  virtual double get_voltage(void) const;
   ...
   */
  virtual std::int32_t
  set_brake_mode(const pros::c::motor_brake_mode_e_t mode) const;
   ...
   */
  virtual std::int32_t
  set_encoder_units(const pros::c::motor_encoder_units_e_t units) const;
   ...
   */
  virtual std::int32_t
  set_gearing(const pros::c::motor_gearset_e_t gearset) const;
