...
class Motor {
	...
	int32_t get_current(void) const;
	int32_t get_current_limit(void) const;
	int32_t get_current_limit_flag(void) const;
	...
	int32_t get_temp_limit_flag(void) const;
	...
	int32_t get_velocity(void) const;
	double get_voltage(void) const;
	int32_t get_voltage_limit(void) const;
	int32_t get_zero_velocity_flag(void) const;
	int32_t get_zero_position_flag(void) const;
	int32_t reset_position(void) const;
	int32_t set_absolute_target(const double position, const int32_t velocity) const;
	...
	int32_t set_position(const double position) const;
	int32_t set_relative_target(const double position, const int32_t velocity) const;
	int32_t set_reverse(const bool reverse) const;
	int32_t set_velocity(const int16_t velocity) const;
	int32_t set_voltage(const int16_t voltage) const;
