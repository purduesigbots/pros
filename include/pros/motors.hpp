...
class Motor {
	 ...
	 */
	explicit Motor(const std::uint8_t port, const pros::c::motor_gearset_e_t gearset, const bool reverse,
	               const pros::c::motor_encoder_units_e_t encoder_units);

	explicit Motor(const std::uint8_t port, const pros::c::motor_gearset_e_t gearset, const bool reverse);

	explicit Motor(const std::uint8_t port, const pros::c::motor_gearset_e_t gearset);
	 ...
	 *         setting errno.
	 */
	virtual std::int32_t set_brake_mode(const pros::c::motor_brake_mode_e_t mode) const;
	 ...
	 *         setting errno.
	 */
	virtual std::int32_t set_encoder_units(const pros::c::motor_encoder_units_e_t units) const;
	 ...
	 */
	static pros::c::motor_pid_s_t convert_pid(double kf, double kp, double ki, double kd);
	 ...
	 * \return A motor_pid_s_t struct formatted properly in 4.4.
	 */
	static pros::c::motor_pid_full_s_t convert_pid_full(double kf, double kp, double ki, double kd, double filter,
	 ...
	 *         setting errno.
	 */
	virtual std::int32_t set_pos_pid(const pros::c::motor_pid_s_t pid) const;
	 ...
	 *         setting errno.
	 */
	virtual std::int32_t set_pos_pid_full(const pros::c::motor_pid_full_s_t pid) const;
	 ...
	 *         setting errno.
	 */
	virtual std::int32_t set_vel_pid(const pros::c::motor_pid_s_t pid) const;
	 ...
	 *         setting errno.
	 */
	virtual std::int32_t set_vel_pid_full(const pros::c::motor_pid_full_s_t pid) const;
	 ...
	 */
	virtual pros::c::motor_brake_mode_e_t get_brake_mode(void) const;
	 ...
	 */
	virtual pros::c::motor_encoder_units_e_t get_encoder_units(void) const;
	 ...
	 */
	virtual pros::c::motor_gearset_e_t get_gearing(void) const;

	/**
	 * Gets the position PID that was set for the motor. This function will return
	 * zero for all of the parameters if the motor_set_pos_pid or motor_set_pos_pid_full
	 ...
	 *         or E_GEARSET_INVALID if the operation failed.
	 */
	virtual pros::c::motor_pid_full_s_t get_pos_pid(void) const;
	 ...
	 *         or E_GEARSET_INVALID if the operation failed.
	 */
	virtual pros::c::motor_pid_full_s_t get_vel_pid(void) const;
