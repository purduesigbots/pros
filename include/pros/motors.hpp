...
class MotorGroup : public BaseMotor {
	public:
...
class Motor : public BaseMotor, public Device {
	public:
	explicit Motor(std::int8_t port, const pros::v5::Motor_Gears gearset, const pros::v5::Motor_Units encoder_units);
