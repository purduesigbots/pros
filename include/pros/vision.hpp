...
class Vision {
	 ...
	 */
	Vision(std::uint8_t port, pros::c::vision_zero_e_t zero_point = pros::c::E_VISION_ZERO_TOPLEFT);
	 ...
	 */
	pros::c::vision_object_s_t get_by_size(const std::uint32_t size_id) const;
	 ...
	 */
	pros::c::vision_object_s_t get_by_sig(const std::uint32_t size_id, const std::uint32_t sig_id) const;
	 ...
	 */
	std::int32_t set_zero_point(pros::c::vision_zero_e_t zero_point) const;
