...
#ifndef _PROS_EXT_ADI_HPP_
#define _PROS_EXT_ADI_HPP_
...
class EXT_ADIPort {
	 ...
	 */
	EXT_ADIPort(std::uint8_t smart_port, std::uint8_t adi_port, adi_port_config_e_t type = E_ADI_TYPE_UNDEFINED);

	virtual ~EXT_ADIPort(void) = default;
...
class EXT_ADIAnalogIn : private EXT_ADIPort {
	public:
	/**
	 ...
	 * failed, setting errno.
	 */
	EXT_ADIAnalogIn(std::uint8_t smart_port, std::uint8_t adi_port);
...
using EXT_ADIPotentiometer = EXT_ADIAnalogIn;
using EXT_ADILineSensor = EXT_ADIAnalogIn;
using EXT_ADILightSensor = EXT_ADIAnalogIn;
using EXT_ADIAccelerometer = EXT_ADIAnalogIn;

class EXT_ADIAnalogOut : private EXT_ADIPort {
	public:
	/**
	 ...
	 *        The configuration type for the port
	 */
	EXT_ADIAnalogOut(std::uint8_t smart_port, std::uint8_t adi_port);
	 ...
	 * failed, setting errno.
	 */
	using EXT_ADIPort::set_value;
};

class EXT_ADIDigitalOut : private EXT_ADIPort {
	public:
	/**
	 ...
	 *        The configuration type for the port
	 */
	EXT_ADIDigitalOut(std::uint8_t smart_port, std::uint8_t adi_port, bool init_state = LOW);
...
class EXT_ADIDigitalIn : private EXT_ADIPort {
	public:
	/**
	 ...
	 *        The configuration type for the port
	 */
	EXT_ADIDigitalIn(std::uint8_t smart_port, std::uint8_t adi_port);
...
using EXT_ADIButton = EXT_ADIDigitalIn;

class EXT_ADIMotor : private EXT_ADIPort {
	public:
	/**
	 ...
	 *        The configuration type for the port
	 */
	EXT_ADIMotor(std::uint8_t smart_port, std::uint8_t adi_port);
...
class EXT_ADIEncoder : private EXT_ADIPort {
	public:
	/**
	 ...
	 */
	EXT_ADIEncoder(std::uint8_t smart_port, std::uint8_t adi_port_top, std::uint8_t adi_port_bottom, bool reversed = false);
...
class EXT_ADIUltrasonic : private EXT_ADIPort {
	public:
	/**
	 ...
	 */
	EXT_ADIUltrasonic(std::uint8_t smart_port, std::uint8_t adi_port_ping, std::uint8_t adi_port_echo);
...
class EXT_ADIGyro : private EXT_ADIPort {
	 ...
	 *        supplied by the ADI
	 */
	EXT_ADIGyro(std::uint8_t smart_port, std::uint8_t adi_port, double multiplier = 1);
