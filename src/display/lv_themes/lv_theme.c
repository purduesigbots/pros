 ...
 * Can't determine the size in compile time because sizeof is not evaluated (should be `sizeof(lv_theme_t) /
 * sizeof(lv_style_t*)`). Error will be generated in run time if too small.*/
