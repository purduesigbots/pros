 ...
 *  STATIC PROTOTYPES
 **********************/
static void refresh_childen_position(lv_obj_t *obj, lv_coord_t x_diff,
                                     lv_coord_t y_diff);
...
lv_res_t lv_obj_del(lv_obj_t *obj) {
  ...
  while (indev) {
    dpar = obj;
    while (dpar != NULL) {
      if (indev->proc.act_obj == dpar || indev->proc.last_obj == dpar) {
...
void lv_obj_report_style_mod(lv_style_t *style) {
  lv_obj_t *i;
  LL_READ(scr_ll, i) { report_style_mod_core(style, i); }
}
 ...
 */
lv_obj_t *lv_obj_get_parent(lv_obj_t *obj) { return obj->par; }
 ...
 */
lv_coord_t lv_obj_get_ext_size(lv_obj_t *obj) { return obj->ext_size; }
 ...
 */
bool lv_obj_get_click(lv_obj_t *obj) { return obj->click == 0 ? false : true; }
 ...
 */
bool lv_obj_get_top(lv_obj_t *obj) { return obj->top == 0 ? false : true; }
 ...
 */
bool lv_obj_get_drag(lv_obj_t *obj) { return obj->drag == 0 ? false : true; }
 ...
 */
uint8_t lv_obj_get_protect(lv_obj_t *obj) { return obj->protect; }
 ...
 */
void *lv_obj_get_ext_attr(lv_obj_t *obj) { return obj->ext_attr; }
 ...
 */
void *lv_obj_get_free_ptr(lv_obj_t *obj) { return obj->free_ptr; }
#endif
 ...
 */
void *lv_obj_get_group(lv_obj_t *obj) { return obj->group_p; }
#endif
