...
static void (*round_cb)(
    lv_area_t *); /*If set then called to modify invalidated areas for special
                     display controllers*/
 ...
 *           px_num: not the drawn pixels but the number of affected pixels of
 * the screen
