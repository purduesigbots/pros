...
static lv_res_t __touch_bits_update_pressed(lv_obj_t *btn) {
  lcd_s_t *lcd = lv_obj_get_ext_attr(
      lv_obj_get_parent(lv_obj_get_parent(lv_obj_get_parent(btn))));
...
uint8_t lcd_read_buttons(void) { return _lcd_read_buttons(_llemu_lcd); }
