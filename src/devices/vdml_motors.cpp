...
// std::vector<pros::v5::Motor_Brake> Motor_Group::get_brake_modes(void) {
// 	std::vector<pros::Motor_Brake> out;
// 	claim_mg_mutex_vector(pros::v5::Motor_Brake::invalid);
// 	for (Motor motor : _motors) {
// 		out.push_back(motor.get_brake_mode);
// 	}
// 	give_mg_mutex_vector(pros::v5::Motor_Brake::invalid);
// 	return out;
// }
