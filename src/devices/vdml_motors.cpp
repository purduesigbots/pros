...
Motor::Motor(const uint8_t port, const motor_gearset_e_t gearset, const bool reverse) : _port(port) {
	set_gearing(gearset);
	set_reversed(reverse);
}

Motor::Motor(const uint8_t port, const motor_gearset_e_t gearset) : _port(port) {
	set_gearing(gearset);
}

Motor::Motor(const uint8_t port, const bool reverse) : _port(port) {
	set_reversed(reverse);
}
...
int32_t Motor::move(int32_t voltage) const {
	return motor_move(_port, voltage);
}

int32_t Motor::move_absolute(const double position, const int32_t velocity) const {
	return motor_move_absolute(_port, position, velocity);
}

int32_t Motor::move_relative(const double position, const int32_t velocity) const {
	return motor_move_relative(_port, position, velocity);
}

int32_t Motor::move_velocity(const int32_t velocity) const {
	return motor_move_velocity(_port, velocity);
}

int32_t Motor::move_voltage(const int32_t voltage) const {
	return motor_move_voltage(_port, voltage);
}

int32_t Motor::modify_profiled_velocity(const int32_t velocity) const {
...
int32_t Motor::get_current_draw(void) const {
...
int32_t Motor::is_over_current(void) const {
...
int32_t Motor::is_over_temp(void) const {
	return motor_is_over_temp(_port);
}

int32_t Motor::is_stopped(void) const {
...
int32_t Motor::is_reversed(void) const {
...
int32_t Motor::get_target_velocity(void) const {
	return motor_get_target_velocity(_port);
}

int32_t Motor::get_voltage(void) const {
...
uint8_t Motor::get_port(void) const {
	return _port;
}

int32_t Motor::tare_position(void) const {
...
int32_t Motor::set_pos_pid(const motor_pid_s_t pid) const {
	return motor_set_pos_pid(_port, pid);
}

int32_t Motor::set_pos_pid_full(const motor_pid_full_s_t pid) const {
	return motor_set_pos_pid_full(_port, pid);
}

int32_t Motor::set_vel_pid(const motor_pid_s_t pid) const {
	return motor_set_vel_pid(_port, pid);
}

int32_t Motor::set_vel_pid_full(const motor_pid_full_s_t pid) const {
	return motor_set_vel_pid_full(_port, pid);
}

int32_t Motor::set_zero_position(const double position) const {
	return motor_set_zero_position(_port, position);
}

int32_t Motor::set_reversed(const bool reverse) const {
