...
MotorGroup::MotorGroup(const std::initializer_list<std::int8_t> ports,
                       const pros::v5::Motor_Gears gearset = pros::v5::Motor_Gears::green const pros::v5::Motor_Units
                           encoder_units = pros::v5::Motor_Units::degrees)
    : _ports(ports) {
	set_gearing(gearset);
...
double MotorGroup::get_actual_velocity(const std::uint8_t index = 0) const {
...
pros::v5::Motor_Brake MotorGroup::get_brake_mode(const std::uint8_t index = 0) const {
...
std::vector<pros::v5::Motor_Brake> MotorGroup::get_brake_mode_all(void) const {
...
std::int32_t MotorGroup::get_current_draw(const std::uint8_t index = 0) const {
	empty_MotorGroup_check(PROS_ERR);
...
std::int32_t MotorGroup::get_current_limit(const std::uint8_t index = 0) const {
	empty_MotorGroup_check(PROS_ERR);
	MotorGroup_index_check(PROS_ERR, index);
...
std::int32_t MotorGroup::is_over_current(const std::uint8_t index = 0) const {
	empty_MotorGroup_check(PROS_ERR);
	MotorGroup_index_check(PROS_ERR, index);
...
std::int32_t MotorGroup::get_direction(const std::uint8_t index = 0) const {
	empty_MotorGroup_check(PROS_ERR);
	MotorGroup_index_check(PROS_ERR, index);
...
double MotorGroup::get_efficiency(const std::uint8_t index = 0) const {
	empty_MotorGroup_check(PROS_ERR_F);
	MotorGroup_index_check(PROS_ERR_F, index);
...
pros::v5::Motor_Units MotorGroup::get_encoder_units(const std::uint8_t index = 0) const {
...
std::vector<pros::v5::Motor_Units> MotorGroup::get_encoder_units_all(void) const {
...
std::uint32_t MotorGroup::get_faults(const std::uint8_t index = 0) const {
	empty_MotorGroup_check(PROS_ERR);
	MotorGroup_index_check(PROS_ERR, index);
...
std::uint32_t MotorGroup::get_flags(const std::uint8_t index = 0) const {
	empty_MotorGroup_check(PROS_ERR);
	MotorGroup_index_check(PROS_ERR, index);
...
pros::v5::Motor_Gears MotorGroup::get_gearing(const std::uint8_t index = 0) const {
...
std::vector<pros::v5::Motor_Gears> MotorGroup::get_gearing_all(void) const {
...
std::int32_t MotorGroup::is_over_temp(const std::uint8_t index = 0) const {
	empty_MotorGroup_check(PROS_ERR);
	MotorGroup_index_check(PROS_ERR, index);
...
double MotorGroup::get_position(const std::uint8_t index = 0) const {
	empty_MotorGroup_check(PROS_ERR_F);
	MotorGroup_index_check(PROS_ERR_F, index);
...
double MotorGroup::get_power(const std::uint8_t index = 0) const {
	empty_MotorGroup_check(PROS_ERR_F);
	MotorGroup_index_check(PROS_ERR_F, index);
...
std::int32_t MotorGroup::is_reversed(const std::uint8_t index = 0) const {
	empty_MotorGroup_check(PROS_ERR);
	MotorGroup_index_check(PROS_ERR, index);
...
double MotorGroup::get_temperature(const std::uint8_t index = 0) const {
	empty_MotorGroup_check(PROS_ERR_F);
	MotorGroup_index_check(PROS_ERR_F, index);
...
double MotorGroup::get_target_position(const std::uint8_t index = 0) const {
	empty_MotorGroup_check(PROS_ERR_F);
	MotorGroup_index_check(PROS_ERR_F, index);
...
double MotorGroup::get_torque(const std::uint8_t index = 0) const {
	empty_MotorGroup_check(PROS_ERR_F);
	MotorGroup_index_check(PROS_ERR_F, index);
...
std::int32_t MotorGroup::get_target_velocity(const std::uint8_t index = 0) const {
	empty_MotorGroup_check(PROS_ERR);
	MotorGroup_index_check(PROS_ERR, index);
...
std::int32_t MotorGroup::get_voltage(const std::uint8_t index = 0) const {
	empty_MotorGroup_check(PROS_ERR);
	MotorGroup_index_check(PROS_ERR, index);
...
std::int32_t MotorGroup::get_voltage_limit(const std::uint8_t index = 0) const {
	empty_MotorGroup_check(PROS_ERR);
	MotorGroup_index_check(PROS_ERR, index);
...
std::int8_t Motor_Group::get_port(const std::uint8_t index) const {
	empty_MotorGroup_check(PROS_ERR);
	MotorGroup_index_check(PROS_ERR, index);
	return _ports[index];
}
...
std::vector<std::int8_t> MotorGroup::get_port_all(void) const {
	...
	for (auto it = _ports.begin(); it < _ports.end(); it++) {
		return_vector.emplace_back((*it));
	}
	return return_vector;
}

std::int8_t Motor_Group::tare_port_all(const std::uint8_t index) const {
	empty_MotorGroup_check(PROS_ERR);
	MotorGroup_index_check(PROS_ERR, index);
...
double Motor::get_actual_velocity(const std::uint8_t index = 0) const {
	if (index != 0) {
		errno = EOVERFLOW;
		return PROS_ERR;
	}
...
std::vector<pros::v5::Motor_Brake> Motor::get_brake_mode_all() const {
	std::vector<pros::v5::Motor_Brake> return_vector;
...
double Motor::get_efficiency(const std::uint8_t index = 0) const {
	if (index != 0) {
		errno = EOVERFLOW;
		return PROS_ERR;
	}
...
pros::v5::Motor_Units Motor::get_encoder_units(const std::uint8_t index = 0) const {
	if (index != 0) {
		errno = EOVERFLOW;
		return PROS_ERR;
	}
...
std::vector<pros::v5::Motor_Units> Motor::get_encoder_units_all(void) const {
	std::vector<pros::v5::Motor_Units> return_vector;
	return_vector.emplace_back(static_cast<pros::v5::Motor_Units>(motor_get_encoder_units(_port)));
	return return_vector;
}

std::uint32_t Motor::get_faults(const std::uint8_t index = 0) const {
	if (index != 0) {
		errno = EOVERFLOW;
		return PROS_ERR;
	}
...
std::uint32_t Motor::get_flags(const std::uint8_t index = 0) const {
	if (index != 0) {
		errno = EOVERFLOW;
		return PROS_ERR;
	}
...
pros::v5::Motor_Gears Motor::get_gearing(const std::uint8_t index = 0) const {
	if (index != 0) {
		errno = EOVERFLOW;
		return PROS_ERR;
	}
...
std::vector<pros::v5::Motor_Gears> Motor::get_gearing_all(void) const {
	std::vector<pros::v5::Motor_Gears> return_vector;
...
std::int32_t Motor::is_over_temp(const std::uint8_t index = 0) const {
	if (index != 0) {
		errno = EOVERFLOW;
		return PROS_ERR;
	}
...
double Motor::get_position(const std::uint8_t index = 0) const {
	if (index != 0) {
		errno = EOVERFLOW;
		return PROS_ERR;
	}
...
double Motor::get_power(const std::uint8_t index = 0) const {
	if (index != 0) {
		errno = EOVERFLOW;
		return PROS_ERR;
	}
...
std::int32_t Motor::is_reversed(const std::uint8_t index = 0) const {
	if (index != 0) {
		errno = EOVERFLOW;
		return PROS_ERR;
	}
...
std::vector<std::uint8_t> Motor::get_port_all(void) const {
...
std::int32_t Motor::set_brake_mode_all(const pros::v5::Motor_Brake mode) const {
	return motor_set_brake_mode(_port, static_cast<pros::motor_brake_mode_e_t>(mode));
}
...
std::int32_t Motor::set_encoder_units_all(const pros::motor_encoder_units_e_t units) {
	return motor_set_encoder_units(_port, units);
}

std::int32_t Motor::set_encoder_units_all(const pros::v5::Motor_Units units) {
	return motor_set_encoder_units(_port, static_cast<motor_encoder_units_e_t>(units));
}

std::int32_t Motor::set_gearing_all(const motor_gearset_e_t gearset) {
	return motor_set_gearing(_port, gearset);
}

std::int32_t Motor::set_gearing_all(const pros::v5::Motor_Gear gearset) {
	return motor_set_gearing(_port, static_cast<motor_gearset_e_t>(gearset));
}
