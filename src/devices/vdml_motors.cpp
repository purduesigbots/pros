...
std::int32_t Motor::move_velocity(const std::int16_t velocity) const {
  return motor_move_velocity(_port, velocity);
}

std::int32_t Motor::move_voltage(const std::int16_t voltage) const {
...
double Motor::get_voltage(void) const { return motor_get_voltage(_port); }
